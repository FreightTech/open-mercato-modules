...
const buildTerminalTrackingCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Terminal Tracking',
...
export function createTerminalTrackingCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildTerminalTrackingCrudOpenApi(options)
}
