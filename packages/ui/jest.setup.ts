...
// jsdom implements neither ResizeObserver nor Element.scrollTo, and the grid
// uses both (sticky-shadow measurement, virtualiser). No-op stubs keep a
// full-table render mountable; anything that depends on real geometry belongs
// in a browser test, not here.
