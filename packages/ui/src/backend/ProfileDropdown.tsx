...
import { useTheme } from '@freighttech/ui/theme'
import { Button } from '../primitives/button'
import { Avatar } from '../primitives-v2/Avatar'
  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex cursor-pointer rounded-full outline-none transition-shadow focus-visible:ring-2 focus-visible:ring-accent-v2 focus-visible:ring-offset-2 focus-visible:ring-offset-topbar-v2-bg"
      >
        <Avatar
          size="sm"
          name={displayName || email}
          icon={<User />}
          className="border border-topbar-v2-field-border bg-topbar-v2-avatar-bg text-topbar-v2-avatar-text"
        />
      </button>
