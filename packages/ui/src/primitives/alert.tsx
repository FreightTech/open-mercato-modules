/**
 * @deprecated Use `Alert` from `@freighttech/ui/components` instead.
 *   The new component matches the Figma "FMS-Componenets" Alert spec
 *   (info / success / warning / error / neutral), pulls colours from
 *   the `--status-*` semantic tokens so dark mode works automatically,
 *   and supports a dismiss button. Will be removed in a future minor.
 */
