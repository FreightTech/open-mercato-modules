/**
 * @deprecated Use `IconButton` from `@freighttech/ui/components` instead.
 *   The new component is a thin wrapper around the new `Button` and
 *   shares the same variant/size system. It also enforces the
 *   `aria-label` prop, which Figma\'s "FMS-Componenets" IconButton
 *   spec requires for a11y. Will be removed in a future minor.
 */
