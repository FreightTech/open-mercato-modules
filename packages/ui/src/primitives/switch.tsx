/**
 * @deprecated Use `Toggle` from `@freighttech/ui/components` instead.
 *   The new component is a native input with `role="switch"`, supports
 *   labels via the `label` prop, and matches the Figma "FMS-Componenets"
 *   Toggle spec. Will be removed in a future minor of `@freighttech/ui`.
 */
