/**
 * @deprecated Use `Badge` from `@freighttech/ui/components` instead.
 *   The new component aligns with the Figma "FMS-Componenets" Badge
 *   spec, exposes typed `variant`/`size` props, optional status dot,
 *   and drops the `class-variance-authority` runtime. Will be removed
 *   in a future minor.
 */
